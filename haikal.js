...
//=================================================//}
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ʜᴡ ᴍᴏᴅꜱ ᴡᴀ`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg',"thumbnail": thumb,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m})} 
...
pporg = 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg'
}
...
//=================================================//
case 'ping': {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `command : ${prefix}
...
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: amukan}, { quoted: m })
}
    }
    break
    ...
    if (!isCreator) return m.reply(mess.owner)
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (args[0] === "lagu") {
                    ...
                    haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{ quoted: m })         
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone1}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone2}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone3}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone4}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone5}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${iphone6}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${buttonkal}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${buttonvirus}` }, { quoted: m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/dea66aa26e286a53d61ea.jpg' }, caption: `ʜᴡ ᴍᴏᴅꜱ ᴡᴀ${ngazap(prefix)}`}, { quoted: m })
}
}
break
case 'haikal': {
